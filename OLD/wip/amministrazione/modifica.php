...
<p>
<form action="<?php echo FUNCTIONPATH;?>azioni.php?azione=modifica&amp;id=<?php echo $_GET['id']?>&cosa=<?php echo $_GET['cosa'];?>" enctype="multipart/form-data" onsubmit="return controllo();" method="post">
<?php $int->genera_form_modifica($_GET['cosa'],$_GET['id']);?>
</form>
</p>
</div>
